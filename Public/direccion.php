...
<body id="inicio">
    ...
    <main>
        <section class="SectionBotones">
            <a class="AOpcion" href="equiposver.html"><button class="ButtonEquipos">EQUIPOS TOTALES</button></a>
            <a class="AOpcion" href="inventariover.html"><button class="ButtonInventario">INVENTARIO</button></a>
        </section>
    </main>
